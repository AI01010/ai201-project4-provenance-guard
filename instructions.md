...
Platforms where people share original creative work — writing & art — are facing a new challenge: how do you know whether what someone posted was made by them, or generated by AI and passed off as human? Not to police creativity, but to protect attribution, build trust, and give audiences the context they actually need.
...
📖 Resources
RepairSafe lab starter (Lab 4): The Week 4 lab repo — a worked example of an AI classification + safety-label backend in the same problem space as this project. https://github.com/codepath/ai201-lab4-repairsafe-starter 
AI Prompting Guide: Patterns for directing AI tools to debug, design, and refine your code. https://courses.codepath.org/courses/ai201/pages/ai_prompting_guide.md 
Flask Quickstart: A 20-minute primer on a minimal POST/GET Flask app, jsonify, Flask-Limiter setup, and a simple log helper. https://courses.codepath.org/courses/ai201/pages/flask_quickstart.md 
